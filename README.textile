...
* SSO users who are new to the sample app will have a User record auto-created with the email address returned from OpenID attribute exchange
...
If using O'Reilly Media's SSO, O'Reilly Media will need to authorize your app's domain to authenticate against the service.
